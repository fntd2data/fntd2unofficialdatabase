const CONFIG = {
  TEXTS: {
    ...
    GENERATOR: {
      ...
      GENERATED_SQUAD: "Generated Squad",
      MANUAL_SELECTION: "Manual Unit Selection",
      ...
      BUILDER_FILTER_CLASS: "All Classes",
      BUILDER_FILTER_SUBCLASS: "All Subclasses",
      ADD_TEAM_MEMBER: "Add",
    ...
    SETTINGS: {
      ...
      THEME_DARK: "Desert Night (Base)",
      THEME_LIGHT: "High Noon Sand",
      THEME_GREEN: "Saguaro Cactus",
      THEME_BLUE: "Oasis Water",
      THEME_RED: "Sunset Canyon",
      THEME_PURPLE: "Wild West Dusk",
    ...
    ADMIN: {
      PANEL_TITLE: "Sheriff's Unit Manager",
      ...
      FORM_FANMADE_BUFFS: "Fanmade Buffs",
      FORM_SUBUNITS: "Subunits / Remakes",
      EXPORT_DATA: "Export",
      IMPORT_DATA: "Import",
    ...
    DETAILS: {
      ...
      STATS_TAB: "Stats & Info",
      PASSIVES_TAB: "Passives & Abilities",
      SOURCES_TAB: "Sources & Aliases",
      RANKED_TAB: "Ranked Info",
      OBTAINMENT_TAB: "Obtainment",
      ALIAS_TAB: "Aliases",
      FANMADE_BUFFS_TAB: "Fanmade Buffs",
      SUBUNITS_TAB: "Subunits",
      DESCRIPTION_TITLE: "Overview",
      FANMADE_BUFFS_TITLE: "Fanmade Improvements",
      SUBUNITS_TITLE: "Subunit Variants",
    ...
    WELCOME: {
      ...
      FEATURE_4: "Bounty Board - Track and manage your sheriff duties",
  ...
  COLORS: {
    DARK: {
      BG_WORKSPACE: "#8b4513", 
      BG_CARD_PANEL: "#a0522d",
      BG_INPUT_FIELD: "#5c2b0e",
      BORDER_MATRIX: "#3d1c00",
      TEXT_HEADING: "#ffd700",
      TEXT_BODY_MAIN: "#ffe2cc",
      TEXT_BODY_MUTED: "#d6a48a",
    ...
    LIGHT: {
      BG_WORKSPACE: "#ff8000", 
      BG_CARD_PANEL: "#ffd880",
      BG_INPUT_FIELD: "#ffebcc",
      BORDER_MATRIX: "#e69100",
      TEXT_HEADING: "#331a00",
      TEXT_BODY_MAIN: "#7a3b11",
      TEXT_BODY_MUTED: "#a35a24",
      COLOR_ACCENT_BLUE: "#e69100",
      COLOR_ACCENT_BLUE_HOVER: "#b35a1a",
      COLOR_CURRENCY_GREEN: "#8a4315",
    },
  ...
  UI_SIZES: {
    BORDER_RADIUS: "4px", // Blocky FNAF World style
  ...
  BACKGROUND_ASSETS: {
    // Sky & Sunset Colors - Made more wild west / dusty
    SKY_COLOR: "#a0522d", 
    SKY_GRADIENT_START: "#cd853f", 
    SKY_GRADIENT_END: "#8b4513", 
    
    // Sun Configuration
    SUN_COLOR: "#ffd700", 
    SUN_SIZE: "400px",
    SUN_POSITION_BOTTOM: "10%", 
    SUN_POSITION_LEFT: "50%", 
    SUN_BLUR_GLOW: "150px",
    SUN_ANIMATION_SPEED: "15s",
    ...
    HOUSE_COLOR: "#8b4513", 
    HOUSE_DARK_COLOR: "#5c2b0e", 
    HOUSE_ROOF_COLOR: "#a0522d", 
    HOUSE_ROOF_DARK: "#8b4513", 
    TUMBLEWEED_COLOR: "#deb887", 
    TUMBLEWEED_DARK: "#8b4513", 
    
    JUMPING_SPEED: "22s",
    JUMP_HEIGHT: "-100px",
    WIND_GUST_DURATION: "3s",
    
    CACTUS_LEFT_BOTTOM: "21%",
    CACTUS_LEFT_2_BOTTOM: "23%",
    CACTUS_RIGHT_BOTTOM: "20%",
    CACTUS_RIGHT_2_BOTTOM: "22%",
    HOUSE_1_BOTTOM: "24%",
    HOUSE_2_BOTTOM: "23%",
    TUMBLEWEED_BOTTOM: "20%",
  },
